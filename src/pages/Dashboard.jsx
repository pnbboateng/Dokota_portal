...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-row h-screen w-screen">
      <div>
        <div
          className={`fixed lg:relative top-0  left-0 h-full w-[260px] bg-rose-950 shadow-xl flex flex-col transform transition-transform duration-300 lg:translate-x-0 z-20  ${
            showSideBar
              ? "translate-x-0"
              : "-translate-x-full px-4 items-center "
          }`}
        >
          <div className="h-[110px] bg-white rounded-full mt-4 w-[110px] border-b-stone-300  px-2 flex justify-start items-center ">
          ...
          <div className="w-full flex-1">
            ...
            <Link to="payments" className="block w-full">
              {" "}
              <div
                className={`group flex gap-4 cursor-pointer mt-1 rounded-lg w-full p-3 hover:bg-[#07131c] ${
                  isPaymentsActive ? "bg-[#07131c]" : ""
                }`} // Active state matches hover state
              >
                <svg
                  fill="white"
                  height="22px"
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <g>
                      ...
                      <path d="M207.5,292h-144c-4.142,0-7.5,3.358-7.5,7.5s3.358,7.5,7.5,7.5h144c4.142,0,7.5-3.358,7.5-7.5S211.642,292,207.5,292z"></path>{" "}
                      ...
                      <path d="M418.197,310.197L327.5,400.894l-42.697-42.697c-2.929-2.929-7.678-2.929-10.606,0c-2.929,2.929-2.929,7.678,0,10.606 l48,48c1.464,1.464,3.384,2.197,5.303,2.197s3.839-0.732,5.303-2.197l96-96c2.929-2.929,2.929-7.678,0-10.606 C425.875,307.268,421.125,307.268,418.197,310.197z"></path>{" "}
                    </g>{" "}
                  </g>
                </svg>{" "}
                <span className="text-[#ffffff]">Payments</span>
              </div>
            </Link>

            <Link to="approvals" className="block w-full">
              <div
                className={`group flex gap-4 cursor-pointer mt-1 hover:bg-[#07131c] rounded-lg w-full p-3 ${
                  isApprovalsActive ? "bg-[#07131c]" : ""
                }`}
              >
                <svg
                  height="22px"
                ...
                <span className="text-[#ffffff]">Approvals</span>
              </div>
            </Link>
            ...
            <Link to="users" className="block w-full">
              ...
              >
                ...
                <span className="text-[#ffffff]">Users</span>
              </div>
            </Link>
          </div>
          ...
          <div className="w-full justify-end">
            <Link to="settings" className="block w-full">
              <div
                className={`group flex mb-4 gap-4 cursor-pointer mt-1 hover:bg-[#07131c] rounded-lg w-full p-3 ${
                  isSettingsActive ? "bg-[#07131c]" : ""
                }`}
              >
                <svg
                  width="24"
                ...
                <span className="text-[#ffffff]">Settings</span>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div>
          {isDropdownOpen && (
            <div>
              ...
              ></div>
              <div className="absolute right-2 mt-1 w-80 bg-white shadow-lg rounded-lg z-[1050] border">
                <div className="bg-rose-100  rounded-t-lg border-b-4 border-b-rose-950">
                  <div className="pt-4 pb-4">
                    <span className="px-6 mt-4 text-2xl font-bold text-red-900">
                      {userName}
                    </span>
